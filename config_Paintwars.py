...
def initialize_robots(arena_size=-1, particle_box=-1): # particle_box: size of the robot enclosed in a square
    ...
    robots = []
    robots.append(robot_challenger.Robot_player(x_init_pos[0], arena_size//2-16+0*8, orientation_champion, name=f"menad_{0}", team="A"))
    robots.append(robot_challenger.Robot_player(x_init_pos[0], arena_size//2-16+1*8, orientation_champion, name=f"menad_{1}", team="A"))
    robots.append(robot_challenger.Robot_player(x_init_pos[0], arena_size//2-16+2*8, orientation_champion, name=f"menad_{2}", team="A"))
    robots.append(robot_challenger.Robot_player(x_init_pos[0], arena_size//2-16+3*8, orientation_champion, name=f"menad_{3}", team="A"))
